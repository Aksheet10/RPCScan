...
if re.search("pingback.ping", postresp):
    ...
    print(f"{Fore.GREEN}References :\n1. https://hackerone.com/reports/752073 - pingback.ping method can cause DDOS/Bruteforce\n2. https://hackerone.com/reports/325040\n3. https://hackerone.com/reports/884756 - Pingback.ping XSPA and Internal Port Scanning\n4. https://the-bilal-rizwan.medium.com/wordpress-xmlrpc-php-common-vulnerabilites-how-to-exploit-them-d8d3c8600b32 - WP xmlrpc.php common vulnerablities and how to exploit them(Recommend)")
else:
...
if re.search("wp.getUserBlogs", postresp):
    ...
    print(f"{Fore.GREEN}Read more here : \n1. https://the-bilal-rizwan.medium.com/wordpress-xmlrpc-php-common-vulnerabilites-how-to-exploit-them-d8d3c8600b32 - WP xmlrpc.php common vulnerablities and how to exploit them\n2. https://protector47.medium.com/how-to-hack-wordpress-website-via-xmlrpc-php-61c813fa3740 - how to hack a wordpress website bia xmlrpc.php")
else:
